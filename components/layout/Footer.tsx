...
export default function Footer() {
  return (
    <footer className="relative mt-auto pt-1">
      <GlassPanel className="rounded-none px-6 pt-16 pb-8">
        <div className="max-w-[1440px] mx-auto relative z-10">
          ...
          <div className="pt-8 border-t border-[var(--glass-border-dim)] flex flex-col md:flex-row justify-between items-center gap-4">
